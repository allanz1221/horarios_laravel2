            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('generaciones.index') }}">generaciones</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('materias.index') }}">materias</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('salones.index') }}">salones</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('generaciones') }}">Generacional</a>
                        </li>
